  ...
  for(;;) {
    switch(state) {
      ...
      case READ_SENSORS:
        ...
        sensorData.dist = sensor.readDist(sensorData.temp,sensorData.hum);

        sensor.printTemp(sensorData.temp);
        sensor.printHum(sensorData.hum);
        sensor.printDist(sensorData.dist);
